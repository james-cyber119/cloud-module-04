...
grandtotal = 0
totalPoints = 7
assessmentName = "module-7-create-assessment"
...
##############################################################################
print('*' * 79)
print("Begin tests for create-env.sh module 7...")
##############################################################################

##############################################################################
# Check Tag values to be 'module7-tag'
##############################################################################
print('*' * 79)
...
f = open('create-env-module-07-results.txt', 'w', encoding="utf-8")
...
print("You should now see a create-env-module-07-results.txt file has been generated.")
f.close
print('*' * 79)